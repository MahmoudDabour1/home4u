...
part of 'certifications_remote_data_source.dart';
...
class _CertificationsRemoteDataSource
  ...
  @override
  Future<GetCertificationsResponseModel> getCertifications() async {
  ...
  Future<DeleteCertificationResponseModel> deleteCertification(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeleteCertificationResponseModel>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AddCertificationResponseModel> addCertification(
    ...
    final _options = _setStreamType<AddCertificationResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddCertificationResponseModel _value;
    try {
      _value = AddCertificationResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
