...
mixin _$ForgetPasswordState<T> {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(ForgetPasswordInitial<T> value) initial,
    required TResult Function(ForgetPasswordLoading<T> value) loading,
    required TResult Function(ForgetPasswordSuccess<T> value) success,
    required TResult Function(ForgetPasswordError<T> value) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(ForgetPasswordInitial<T> value)? initial,
    TResult? Function(ForgetPasswordLoading<T> value)? loading,
    TResult? Function(ForgetPasswordSuccess<T> value)? success,
    TResult? Function(ForgetPasswordError<T> value)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
/// @nodoc
abstract class _$$ForgetPasswordInitialImplCopyWith<T, $Res> {
  factory _$$ForgetPasswordInitialImplCopyWith(
          _$ForgetPasswordInitialImpl<T> value,
          $Res Function(_$ForgetPasswordInitialImpl<T>) then) =
      __$$ForgetPasswordInitialImplCopyWithImpl<T, $Res>;
}

/// @nodoc
class __$$ForgetPasswordInitialImplCopyWithImpl<T, $Res>
    extends _$ForgetPasswordStateCopyWithImpl<T, $Res,
        _$ForgetPasswordInitialImpl<T>>
    implements _$$ForgetPasswordInitialImplCopyWith<T, $Res> {
  __$$ForgetPasswordInitialImplCopyWithImpl(
      _$ForgetPasswordInitialImpl<T> _value,
      $Res Function(_$ForgetPasswordInitialImpl<T>) _then)
      : super(_value, _then);
...
class _$ForgetPasswordInitialImpl<T> implements ForgetPasswordInitial<T> {
  const _$ForgetPasswordInitialImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ForgetPasswordInitialImpl<T>);
  }
...
abstract class ForgetPasswordInitial<T> implements ForgetPasswordState<T> {
  const factory ForgetPasswordInitial() = _$ForgetPasswordInitialImpl<T>;
}
