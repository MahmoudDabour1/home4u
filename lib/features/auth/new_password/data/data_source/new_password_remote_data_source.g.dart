...
part of 'new_password_remote_data_source.dart';
...
class _NewPasswordRemoteDataSource implements NewPasswordRemoteDataSource {
  ...
  Future<NewPasswordResponseModel> newPassword(
    ...
    late NewPasswordResponseModel _value;
    try {
