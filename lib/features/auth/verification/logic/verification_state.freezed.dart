...
mixin _$VerificationState<T> {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(VerificationInitial<T> value) initial,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(VerificationInitial<T> value)? initial,
...
/// @nodoc
abstract class _$$VerificationInitialImplCopyWith<T, $Res> {
  factory _$$VerificationInitialImplCopyWith(_$VerificationInitialImpl<T> value,
          $Res Function(_$VerificationInitialImpl<T>) then) =
      __$$VerificationInitialImplCopyWithImpl<T, $Res>;
}

/// @nodoc
class __$$VerificationInitialImplCopyWithImpl<T, $Res>
    extends _$VerificationStateCopyWithImpl<T, $Res,
        _$VerificationInitialImpl<T>>
    implements _$$VerificationInitialImplCopyWith<T, $Res> {
  __$$VerificationInitialImplCopyWithImpl(_$VerificationInitialImpl<T> _value,
      $Res Function(_$VerificationInitialImpl<T>) _then)
      : super(_value, _then);
...
class _$VerificationInitialImpl<T> implements VerificationInitial<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$VerificationInitialImpl<T>);
  }
...
abstract class VerificationInitial<T> implements VerificationState<T> {
  const factory VerificationInitial() = _$VerificationInitialImpl<T>;
}
