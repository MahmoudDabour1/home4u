final Map<String, List<String>> egyptLocations = {
  ...
  "Minya": ["Minya City", "Mallawi", "Beni Mazar", "Samalut", "Maghagha"],
  "Beni Suef": ["Beni Suef City", "El Wasta", "Nasser", "Al Fashn"],
  "Assiut": ["Assiut City", "Abnub", "Manfalut", "Dayrout", "Qusiya"],
  "Sohag": ["Sohag City", "Akhmim", "Girga", "Tahta", "El Maragha"],
  "Ismailia": ["Ismailia City", "Fayed", "Qantara West", "Qantara East"],
  ...
  "Damietta": ["Damietta City", "New Damietta", "Ras El Bar", "Faraskur"],
  "Kafr El Sheikh": ["Kafr El Sheikh City", "Desouk", "Fouh", "Baltim"],
  "Monufia": ["Shebin El Kom", "Menouf", "Ashmoun", "Tala", "Bagour"],
