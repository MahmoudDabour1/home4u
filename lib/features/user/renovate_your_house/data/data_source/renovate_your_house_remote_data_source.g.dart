...
class _RenovateYourHouseRemoteDataSource
  ...
  Future<RenovateYourHouseFixedPackagesFilterResponse>
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(renovateYourHouseFixedProductsFilter);
    final _options =
        _setStreamType<RenovateYourHouseFixedPackagesFilterResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RenovateYourHouseFixedPackagesFilterResponse _value;
    try {
      _value =
          RenovateYourHouseFixedPackagesFilterResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<RenovateYourHouseCustomPackagesFilterResponse>
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(renovateYourHouseCustomFilter);
    final _options =
        _setStreamType<RenovateYourHouseCustomPackagesFilterResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RenovateYourHouseCustomPackagesFilterResponse _value;
    try {
      _value =
          RenovateYourHouseCustomPackagesFilterResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
