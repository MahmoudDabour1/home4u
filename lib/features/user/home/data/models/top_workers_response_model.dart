...
part 'top_workers_response_model.g.dart';
@JsonSerializable()
class TopWorkersResponseModel {
  ...
  TopWorkersResponseModel({
    this.success,
    this.status,
    this.data,
  });

  factory TopWorkersResponseModel.fromJson(Map<String, dynamic> json) => _$TopWorkersResponseModelFromJson(json);

  Map<String, dynamic> toJson() => _$TopWorkersResponseModelToJson(this);
}
