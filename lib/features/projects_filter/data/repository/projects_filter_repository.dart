...
abstract class ProjectsFilterRepository {
  ...
  Future<ApiResult<AllCustomPackageLookUpResponseModel>>
      allCustomPackageLookAUp();

  Future<ApiResult<AskEngineerLookUpResponseModel>>
      askEngineerLookAUp();

  Future<ApiResult<AskWorkerLookUpResponseModel>>
      askWorkerLookAUp();
}
...
class ProjectsFilterRepositoryImpl implements ProjectsFilterRepository {
  ...
  @override
  Future<ApiResult<AllCustomPackageLookUpResponseModel>>
      allCustomPackageLookAUp() async {
    try {
      final response = await remoteDataSource.getAllCustomPackageLookUp();
      return ApiResult.success(response);
    } catch (e) {
      return ApiResult.failure(ApiErrorHandler.handle(e.toString()));
    }
  ...
  @override
  Future<ApiResult<AskEngineerLookUpResponseModel>> askEngineerLookAUp() async{
    try {
      final response = await remoteDataSource.getAskEngineerLookUp();
      return ApiResult.success(response);
    } catch (e) {
      return ApiResult.failure(ApiErrorHandler.handle(e.toString()));
    }
  ...
  @override
  Future<ApiResult<AskWorkerLookUpResponseModel>> askWorkerLookAUp() async{
    try {
      final response = await remoteDataSource.getAskWorkerLookUp();
      return ApiResult.success(response);
    } catch (e) {
      return ApiResult.failure(ApiErrorHandler.handle(e.toString()));
    }
