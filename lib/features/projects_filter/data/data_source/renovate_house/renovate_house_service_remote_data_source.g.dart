...
part of 'renovate_house_service_remote_data_source.dart';
...
class _RenovateHouseServiceRemoteDataSource
    implements RenovateHouseServiceRemoteDataSource {
  ...
  Future<RenovateHouseSingleRequestResponseModel> requestAskRenovateHouse(
      AddRenovateHouseRequestBody askRenovateHouseRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(askRenovateHouseRequestBody.toJson());
    final _options =
        _setStreamType<RenovateHouseSingleRequestResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late RenovateHouseSingleRequestResponseModel _value;
    try {
      _value = RenovateHouseSingleRequestResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
