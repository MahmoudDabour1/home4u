...
class AddOfferRenovateHouseCustomPackageButton extends StatefulWidget {
  final num? requestCount;
  final int askId;

  const AddOfferRenovateHouseCustomPackageButton({
    super.key,
    this.requestCount,
    required this.askId,
  });
  ...
  @override
  State<AddOfferRenovateHouseCustomPackageButton> createState() =>
      _AddOfferRenovateHouseCustomPackageButtonState();
}

class _AddOfferRenovateHouseCustomPackageButtonState
    extends State<AddOfferRenovateHouseCustomPackageButton> {
  String? _userType;
  ...
  Widget _buildAddButton(BuildContext context) {
    return AppCustomAddButton(
      ...
      onPressed: () {
        context.pushNamed(
          Routes.addOfferRenovateHouseCustomPackageScreen,
