      ...
      child: Column(
        ...
        children: [
          ...
          FilterImageAndNameWidget(
            imageUrl: requestDesignItem.user?.personalPhoto,
            userName: requestDesignItem.user?.username,
            timeAgo: formatDate(requestDesignItem.createdDate),
          ),
          ServicesConstData(
            government: requestDesignItem.governorate?.name ?? 'N/A',
            projectStatus:  requestDesignItem.askStatus ?? 'N/A',
          ),
        ],
      ),
    );
