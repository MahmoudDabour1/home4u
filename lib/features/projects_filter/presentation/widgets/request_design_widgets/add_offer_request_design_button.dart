...
class AddOfferRequestDesignButton extends StatefulWidget {
  final num? requestCount;
  final int askId;

  const AddOfferRequestDesignButton({
    super.key,
    this.requestCount,
    required this.askId,
  });
  ...
  @override
  State<AddOfferRequestDesignButton> createState() =>
      _AddOfferRequestDesignButtonState();
}

class _AddOfferRequestDesignButtonState
    extends State<AddOfferRequestDesignButton> {
  String? _userType;
  ...
  Widget _buildAddButton(BuildContext context) {
    return AppCustomAddButton(
      ...
      onPressed: () {
        context.pushNamed(
          Routes.addOfferRequestDesignScreen,
