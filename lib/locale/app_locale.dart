class AppLocale {
  ...
  static const Map<String, dynamic> en = {
    ...
    forgetPasswordK: 'Forget Password',
    ...
    didnReceiveTheOTP: 'Didn\'t receive the OTP?',
    resendIn00: 'Resend in 00:',
    ...
    technicalWorkerTypes: 'Technical Worker Types',
    technicalWorkerServices: 'Technical Worker Services',
    delete: 'Delete',
    edit: 'Edit',
  ...
  static const Map<String, dynamic> ar = {
    ...
    pleaseEnterAValidEmailAddress: 'الرجاء إدخال بريد إلكتروني صحيح',
    pleaseEnterAValidPhoneNumber: 'الرجاء إدخال رقم هاتف صحيح',
    pleaseEnterAValidPassword: 'الرجاء إدخال كلمة مرور صحيحة',
    enterValidName: 'أدخل اسماً صحيحاً',
    ...
    forgetPasswordK: 'هل نسيت كلمة المرور؟',
    enterYourEmailAddress: 'أدخل عنوان بريدك الإلكتروني',
    send: 'إرسال',
    verification: 'التحقق',
    pleaseVerifyYourAccount: 'الرجاء التحقق من حسابك',
    continue0: 'استمرار',
    resendIn: 'إعادة الإرسال خلال ',
    resendOTP: 'إعادة إرسال رمز التحقق',
    didnReceiveTheOTP: 'ألم تستلم رمز التحقق؟',
    resendIn00: 'إعادة الإرسال خلال 00:',
    ...
    technicalWorkerTypes: 'أنواع العمال الفنيين',
    technicalWorkerServices: 'خدمات العمال الفنيين',
    delete: 'حذف',
    edit: 'تعديل',
